...
import com.dbhh.data.RaidersListBean;
...
import static com.dbhh.other.RequestFlag.GET_APP_MODULE;
import static com.dbhh.other.RequestFlag.GET_BANK;
import static com.dbhh.other.RequestFlag.GET_BANNER;
import static com.dbhh.other.RequestFlag.GET_CODE;
import static com.dbhh.other.RequestFlag.GET_FIND_BY_ID;
import static com.dbhh.other.RequestFlag.GET_FIND_BY_STRATEGY_ID;
import static com.dbhh.other.RequestFlag.GET_FIND_PARAMETER;
import static com.dbhh.other.RequestFlag.GET_HEAD_LINES;
import static com.dbhh.other.RequestFlag.GET_LIST;
import static com.dbhh.other.RequestFlag.GET_PRODUCT_HOT;
import static com.dbhh.other.RequestFlag.GET_PRODUCT_RECOMMEND;
import static com.dbhh.other.RequestFlag.GET_PRODUCT_SHARP;
import static com.dbhh.other.RequestFlag.GET_TOP;
import static com.dbhh.other.RequestFlag.GET_TU;
...
//    }
     ...
     * @param sCode  验证码
     */
    public static void postLogin(PXHttp.OnResultHandler handler, String sPhone, String sCode,String loginType,String oclToken) {
        HashMap<String, String> params = new HashMap<>();
        ...
        params.put("channelNo", InitDatas.CHANNEL_NO);
        params.put("oclToken", oclToken);
        params.put("device", "Android");
        JSONObject jsonObject = new JSONObject(params);
        PXHttp.getInstance().setHandleInterface(handler).upJson(Urls.URL_POST_LOGIN,jsonObject, POST_LOGIN,UserDto.class);
    }
