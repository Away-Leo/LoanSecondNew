...
import com.dbhh.ui.activity.FrontLoginActivity;
import com.dbhh.ui.activity.LoginActivity;
import com.dbhh.ui.activity.ProductInfoActivity;
...
public abstract class BaseFragment<SV extends ViewDataBinding> extends Fragment {
    ...
    public void isLoginToWeb(Bundle bundle) {
        if (!SharedPrefsUtil.getValue(mActivity, InitDatas.SP_NAME, InitDatas.UserIsLogin, false)) {
            ActivityUtil.recallGoForward(mActivity,FrontLoginActivity.class,PXSimpleWebViewActivity.class,bundle,false);
        } else {
